...
import net.prominic.groovyls.groovydoc.html.SubstitutionTextReader;

/**
 * Processes GroovyDoc tags.
 * <p>
 * Copied into this package from
 * <code>org.eclipse.jdt.ls.core.internal.javadoc.html.SingleCharReader</code>.
 */
public class GroovyDoc2HTMLTextReader extends SubstitutionTextReader {
  ...
  public GroovyDoc2HTMLTextReader(Reader reader) {
    super(reader);
   ...
   * @see #addPreFormatted(StringBuilder, String) for rendering with an
   *      {@link HTML2TextReader}
   */
